...
## AIM:
To implement inheritance and method overriding to compute discounted gold prices for different customer types.

## ALGORITHM :
1. Read customer details: ID, name, purchase weight, gold rate, type.
2. Create a base class Customer with methods:
       - getDiscountRate()
       - calculateFinalPrice()
       - display()
3. Create RegularCustomer by overriding getDiscountRate() → return 2.
4. Create PremiumCustomer by overriding getDiscountRate() → return 5.
5. PremiumCustomer also calculates cashback = 1% of final price.
6. Based on the customer type, create the correct object.
7. Call display() to print all details.
...
<img width="434" height="353" alt="image" src="https://github.com/user-attachments/assets/c344b2d9-7ef0-424c-9def-ad2639b6cd8a" />


## RESULT:
The program successfully calculates discounted gold prices using inheritance and method overriding.
